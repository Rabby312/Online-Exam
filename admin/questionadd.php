...
echo "<BR><h2 class=head1>Add Question </h2>";
if(isset($_POST["submit"]))
{
if(!empty($_POST["submit"]=='Save' || strlen($_POST["testid"]))>0 )
{
extract($_POST);
...
<?php
$sql1="Select * from mst_test order by test_name";
